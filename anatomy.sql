...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 08-Maio-2019 às 21:33
...
(5, 'Digital', 'eu quero um serviÃ§o', 'quero que meu serviÃ§o seja assim, assado!!!', 'Folder Paginado atÃ© 10 pgs - Materiais Impressos', 6, ''),
(6, 'Digital', 'eu gostaria de um serviÃ§o', 'lalalal teste aqui', 'Cover de facebook - Materiais Digitais', 7, ''),
(7, 'Selecione', 'mais um? serÃ¡ que rola?', 'teste de UTF-8 !@#$%Â¨&*() Ã©Ã©Ã©Ã£Ã£Ã£Ã´Ã´Ã´Ã´', 'Envelope carta - Materiais Impressos', 7, '');
