...
<div id="right-panel" class="right-panel">
    ...
    <div class="content">
    <h1 class="title">SOLICITAÇÕES APROVADAS</h1>
    <div class="row">
        ...
        <div class="row pT2">
            ...
            if($nServicos <= $max):
                if($servico->status == 'aprovado' && $servico->destinado == $_SESSION['usuario'] || $servico->status == 'aprovado' && $_SESSION['funcao'] == 'admin'):
                    $nServicos++;
            ?>
                <div class="col-md-6">
                    <div class="card" style="background-color:rgba(0,255,0,0.2);">
