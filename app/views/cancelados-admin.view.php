...
<div id="right-panel" class="right-panel">
    ...
    <div class="content">
    <h1 class="title">SOLICITAÇÕES CANCELADAS</h1>
    <div class="row">
        ...
        <div class="row pT2">
            ...
            if($nServicos <= $max):
                if($servico->status == 'cancelado' && $servico->destinado == $_SESSION['usuario'] || $servico->status == 'cancelado' && $_SESSION['funcao'] == 'admin'):
                    $nServicos++;
            ?>
                <div class="col-md-6">
